...
class Book
{
    ...
    public function __construct(string $id, string $title, string $genre_id, string $language_id, string $date_of_publication, int $pageCount, string $image, string $description, string $upload_date, int $accept_date, int $created_by)
    {
        $this->id = $id;
        $this->title = $title;
